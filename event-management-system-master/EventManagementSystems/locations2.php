                ...
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Grand Dining Room</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Grand Dining Room</h1><!--location title-->
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="ananasbar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">JW Marriot/h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                                            ...
                                            <div class="modaltext1 col-md-6">
                                                <h5>Bra and Brasserie</h5><!--content title-->
                                                <p>
                                                Club, Bar & Brasserie
                                                </p>
                                            </div> 
                        ...
                        <div class="subcontent col-md-8"><!--location non modal content -->
                            <h1 class="title">Bar & Brasserie</h1><!--location title-->
                            <p class="location">JW Marriot</p><!--location secondary content-->
                            <p class="definition">
                            Bar & Brasserie is the best hangout spot for friends and drinks
                            </p>
                            <hr class="customline3"><!--css modified horizontal line--> 
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="modal fade" id="argyle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--location modal content-->
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button><!--close button on top-->
                                        <h4 class="modal-title" id="myModalLabel">The Casket</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">The Casket</h1>
                            <p class="location">Leela Palace</p>
                            <p class="definition">the best bar in town</p>
            ...
            <div class="row"><!--location content -->
                <section>
                    <div class="container">
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header"><!--modal header-->
                                        ...
                                        <h4 class="modal-title" id="myModalLabel">Cafe Noice</h4><!--modal title-->
                                    </div>
                                    <div class="row">
                                        <div class="modal-body"><!--modal content-->
                                            <div class="col-md-6"><!--image holder with 6 grid column-->
                        ...
                        <div class="subcontent col-md-8">
                            <h1 class="title">Noice Cafe</h1>
                            <p class="location">Hotel Ashok</p>
                            <p class="definition">This fantastic venue is our latest venture.</p>
                            <hr class="customline3">   
